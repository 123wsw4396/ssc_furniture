...
public class AmethyAxeItem extends AxeItem {
    public AmethyAxeItem(Tier tier,float attackDamage,float attackSpeed,Properties properties){ //声明新斧头类型继承原版斧头
        super(tier,attackDamage,attackSpeed,properties);//调用父类AxeItem的构造函数，把参数传上去，初始化父类
    }
    @Override
