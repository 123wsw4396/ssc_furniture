...
/**
 * 塑形蛛丝发射器 (钻石). 装备到手/额外手饰品槽后, 蜘蛛形态主/备能力键触发发射.
 * 装备无耐久; 消耗蛛丝更省 (11/9/7).
 */
public class ShapingGrapplingHookDiamondItem extends AccessoryItem {

    public ShapingGrapplingHookDiamondItem(Properties settings) {
        super(settings);
    }
